...
namespace ExampleGame
{
    public static partial class BuilderExtension
    {
        ...
        public static Collider2D GetOrAddColliderType2D(this GameObject gameObject, EnemyType type)
        {
            return type switch
            {
                EnemyType.Box => gameObject.GetOrAddComponent<BoxCollider2D>(),
                EnemyType.Round => gameObject.GetOrAddComponent<CircleCollider2D>(),
